...
instance_create_layer(0, 0, "Instances", obj_Player, { num: 1, hand: player_hand });
...
instance_create_layer(5,0, "Instances", obj_Op1Tut, {hand: op1_hand});
...
instance_create_layer(10,0, "Instances", obj_Op2Tut, {hand: op2_hand});
...
running_intro_text = 200;
// 1. Pick base
global.tut_pick_base = false;
base_picked = false;
