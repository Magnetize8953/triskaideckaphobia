// packet identifiers
enum NETWORK {
    JOINING,                // (u8) server-side id, (u8) hand size, (u8, loop 13) player's hand, (u8) pot size, (u8, loop) pot
    ...
    HONEST_HAND,            // (u8) player id, (u8, loop 255-terminated) cards
    BLUFFED_HAND,           // (u8) player id, (u8, loop 255-terminated) cards
    NEXT_TURN,              // 
    NEXT_ROUND,             // 
