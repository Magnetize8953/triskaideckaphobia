...
// For tutorial only
if (!global.base_card and global.card_being_selected and instance_exists(obj_Tutorial) and self.card_id == 1) {
...
// Else if, for normal, there is no base card, and a base card is being selected
} else if (!global.base_card and global.card_being_selected and !instance_exists(obj_Tutorial)) {
	// No more card being selected
	global.card_being_selcted = false;
	global.base_card = true;
